...
namespace FitnessApp.Views.Meal
{
	...
	public partial class SelectEditFoodPage : ContentPage
	{
        public SelectEditFoodViewModel ViewModel;

		public SelectEditFoodPage ()
		{
			InitializeComponent ();

            this.ViewModel = new SelectEditFoodViewModel()
            {
                Title = this.Title
            };
